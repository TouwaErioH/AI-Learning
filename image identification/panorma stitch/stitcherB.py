# -*- coding: utf-8 -*-
"""
Created on Sun Oct 13 19:48:29 2019
...
MIN = 10
starttime=time.time()
img1 = cv2.imread('D:/test1.jpg') #query
img2 = cv2.imread('D:/test2.jpg') #train
...
#cv2.imshow("Result",warpImg)
        ...
        cv2.imwrite("D:/simplepanorma.png",direct)
        cv2.imwrite("D:/bestpanorma.png",warpImg)
